...
void fiat_pasta_fq_mul(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  ...
  x19 = (x18 + x6);
  fiat_pasta_mulx_u64(&x20, &x21, x11, UINT64_C(0x8c46eb20ffffffff));
  fiat_pasta_mulx_u64(&x22, &x23, x20, bb);
  fiat_pasta_mulx_u64(&x24, &x25, x20, UINT64_C(0x224698fc0994a8dd));
  fiat_pasta_mulx_u64(&x26, &x27, x20, UINT64_C(0x8c46eb2100000001));
  ...
  fiat_pasta_mulx_u64(&x66, &x67, x56, UINT64_C(0x8c46eb20ffffffff));
  ...
  fiat_pasta_mulx_u64(&x113, &x114, x103, UINT64_C(0x8c46eb20ffffffff));
  fiat_pasta_mulx_u64(&x115, &x116, x113, bb);
  fiat_pasta_mulx_u64(&x117, &x118, x113, UINT64_C(0x224698fc0994a8dd));
  fiat_pasta_mulx_u64(&x119, &x120, x113, UINT64_C(0x8c46eb2100000001));
  ...
  fiat_pasta_mulx_u64(&x160, &x161, x150, UINT64_C(0x8c46eb20ffffffff));
  fiat_pasta_mulx_u64(&x162, &x163, x160, bb);
  fiat_pasta_mulx_u64(&x164, &x165, x160, UINT64_C(0x224698fc0994a8dd));
  fiat_pasta_mulx_u64(&x166, &x167, x160, UINT64_C(0x8c46eb2100000001));
  ...
  fiat_pasta_subborrowx_u64(&x182, &x183, 0x0, x173, UINT64_C(0x8c46eb2100000001));
  fiat_pasta_subborrowx_u64(&x184, &x185, x183, x175, UINT64_C(0x224698fc0994a8dd));
  fiat_pasta_subborrowx_u64(&x186, &x187, x185, x177, 0x0);
  fiat_pasta_subborrowx_u64(&x188, &x189, x187, x179, bb);
...
void fiat_pasta_fq_add(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  ...
  fiat_pasta_subborrowx_u64(&x9, &x10, 0x0, x1, UINT64_C(0x8c46eb2100000001));
  fiat_pasta_subborrowx_u64(&x11, &x12, x10, x3, UINT64_C(0x224698fc0994a8dd));
  fiat_pasta_subborrowx_u64(&x13, &x14, x12, x5, 0x0);
  fiat_pasta_subborrowx_u64(&x15, &x16, x14, x7, bb);
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
void fiat_pasta_fq_selectznz(uint64_t out1[4], fiat_pasta_uint1 arg1, const uint64_t arg2[4], const uint64_t arg3[4]) {
