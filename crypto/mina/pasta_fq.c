 ...
 *   out2: [0x0 ~> 0x1]
 */
void fiat_pasta_fq_subborrowx_u64(uint64_t* out1, fiat_pasta_uint1* out2, fiat_pasta_uint1 arg1, uint64_t arg2, uint64_t arg3) {
 ...
 *   out1: [0x0 ~> 0xffffffffffffffff]
 */
void fiat_pasta_fq_cmovznz_u64(uint64_t* out1, fiat_pasta_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  fiat_pasta_uint1 x1;
  uint64_t x2;
  x1 = (!(!arg1));
...
void fiat_pasta_fq_mul(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  ...
  fiat_pasta_fq_mulx_u64(&x22, &x23, x20, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x68, &x69, x66, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x115, &x116, x113, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x162, &x163, x160, bb);
  ...
  fiat_pasta_fq_subborrowx_u64(&x188, &x189, x187, x179, bb);
...
void fiat_pasta_fq_add(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  ...
  fiat_pasta_fq_subborrowx_u64(&x15, &x16, x14, x7, bb);
...
void fiat_pasta_fq_from_montgomery(uint64_t out1[4], const uint64_t arg1[4]) {
  ...
  fiat_pasta_fq_mulx_u64(&x4, &x5, x2, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x20, &x21, x18, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x44, &x45, x42, bb);
  ...
  fiat_pasta_fq_subborrowx_u64(&x91, &x92, x90, x84, bb);
...
void fiat_pasta_fq_to_montgomery(uint64_t out1[4], const uint64_t arg1[4]) {
  ...
  fiat_pasta_fq_mulx_u64(&x21, &x22, x19, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x61, &x62, x59, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x101, &x102, x99, bb);
  ...
  fiat_pasta_fq_mulx_u64(&x141, &x142, x139, bb);
  ...
  fiat_pasta_fq_subborrowx_u64(&x164, &x165, x163, x157, bb);
...
void fiat_pasta_fq_divstep(uint64_t* out1, uint64_t out2[5], uint64_t out3[5], uint64_t out4[4], uint64_t out5[4], uint64_t arg1, const uint64_t arg2[5], const uint64_t arg3[5], const uint64_t arg4[4], const uint64_t arg5[4]) {
  ...
  fiat_pasta_fq_subborrowx_u64(&x45, &x46, x44, x37, bb);
  ...
  fiat_pasta_fq_subborrowx_u64(&x108, &x109, x107, x100, bb);
